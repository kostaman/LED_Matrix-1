...
## License
This project is licensed under GPL 3. See [LICENSE](https://github.com/daveythacher/LED_Matrix/blob/main/LICENSE) for more details about terms and conditions that apply.
